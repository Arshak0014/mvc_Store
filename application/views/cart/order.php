...
<div style="padding-top: 105px">
    ...
    <p style="font-size: 18px" class="p-3">Are you want confirm order <b style="color: green">"<?= $data[0]['name'] ?>"</b>?</p>
    <p style="font-size: 18px" class="p-3">You are going to pay <b style="color: green"><?= $data[0]['price'] * $data[1] ?> $</b></p>
